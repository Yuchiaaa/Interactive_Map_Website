...
def truncate_kadastralekaart():
    """
    Empties all rows from the 'kadastralekaart_perceel' table without destroying the schema.

    Use this before re-loading BRK data (e.g. when a new quarterly extract is
    available from https://www.nationaalgeoregister.nl/geonetwork/srv/dut/catalog.search#/metadata/a29917b9-3426-4041-a11b-69bcb2256904)
    ...
    try:
        with engine.begin() as conn:
            ...
            if exists:
                ...
                print(f"⚠️  Table '{table_name}' does not exist yet. Run load_kadastralekaart.py first.")
