...
def truncate_bag():
    """
    Empties all rows from the 'bag_buildings' table without destroying the schema.

    Use this before re-loading BAG data (e.g. when a new quarterly extract is
    available from https://www.pdok.nl/introductie/-/article/basisregistratie-adressen-en-gebouwen-ba-1)
    ...
    try:
        with engine.begin() as conn:
            ...
            if exists:
                ...
                print(f"⚠️  Table '{table_name}' does not exist yet. Run load_bag.py first.")
