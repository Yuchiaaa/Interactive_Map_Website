...
def truncate_grenzen():
    ...
    Use this before re-loading Bestuurlijke Grenzen data (e.g. when an updated
    export is available from https://www.pdok.nl/introductie/-/article/bestuurlijke-grenzen)
    ...
    try:
        with engine.begin() as conn:
            ...
            if exists:
                ...
                print(f"⚠️  Table '{table_name}' does not exist yet. Run load_grenzen.py first.")
