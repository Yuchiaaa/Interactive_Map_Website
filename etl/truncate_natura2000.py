...
def truncate_natura2000():
    """
    Empties all rows from the 'natura2000_areas' table without destroying the schema.

    Use this before re-loading Natura 2000 data (e.g. when an updated boundary
    export is available from https://www.pdok.nl/introductie/-/article/natura-2000)
    ...
    try:
        with engine.begin() as conn:
            ...
            if exists:
                ...
                print(f"⚠️  Table '{table_name}' does not exist yet. Run load_natura2000.py first.")
